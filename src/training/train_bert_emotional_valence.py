"""
train_bert_emotional_valence_shift.py - Fine-tune BERT to predict emotional valence shift scores
...
class TimeCompressionDataset(Dataset):
    """Dataset for certainty emotional valence shift regression"""
...
def load_training_data():
    ...
    pg_cursor.execute("""
        SELECT story_id, emotional_valence_shift 
        FROM zero_shot_labels 
        WHERE emotional_valence_shift IS NOT NULL
    """)
...
def train_model(texts, scores, epochs=3, batch_size=16, lr=2e-5):
    """Fine-tune BERT on emotional valence shift scores"""
    ...
    for epoch in range(epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            }, 'models/bert_emotional_valence_shift.pt')
...
def test_model(model, tokenizer, device):
    ...
    for text in test_texts:
        ...
        print(f"\nText: {text[:60]}...")
        print(f"Predicted emotional_valence_shift: {score:.3f}")
...
if __name__ == "__main__":
    ...
    print("="*60)
    print("BERT Emotional Valence Training")
    print("="*60)
    ...
    print("\n" + "="*60)
    print("Training complete! Model saved to models/bert_emotional_valence_shift.pt")
    print("="*60)